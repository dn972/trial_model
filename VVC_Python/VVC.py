...
#Define
CODING_SCHEME_CFG_NAME = "vvenc_all_intra"#"randomaccess_fast"
CODING_SCHEME_CFG_NAME_VTM = "encoder_intra_vtm"
INPUT_BIT_DEPTH = 8
INPUT_CHROMA_FORMAT = 420
NUM_FRAMES = 1
METHOD = "OrgUbuntu"
BITSTREAM_FOLDER = "/media/hdd1/ngoc/NAS/Input_Generation_VCM_WS04/VCM_for_images/VVC_Python/"
EXECUTABLE_FILE_NAME = BITSTREAM_FOLDER + "vvencFFapp_OrgUbuntu" 
...
def main():
    ...
    IFrameCompressor.load_state_dict(checkpoint)
    x_hat = IFrameCompressor(x_in)
    utils_tv.save_image(x_hat["x_hat"], os.path.join('/media/EXT0/daole/sd_scripts/VVC_Python/compressai/output/', f"test_out_bmshj2018-factorized_ssim.png"), nrow=1)
